...
const uploadMetadata = async (
  ...
  for (let i = 1; i < editionSize + 1; i++) {
    ...
    imageDataArray[
      i
    ].filePath = `https://ipfs.mir.one:2053/ipfs/${imageCID}/images/${paddedHex}.png`;
    ...
    // upload metafile data to MIR
    const metaFile = new MIR.File(filename, {
      base64: Buffer.from(
  ...
  // once all promises back then save to IPFS and MIR database
