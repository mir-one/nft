...
/*!-Paginator*/
var pe=t('.paginator[role="navigation"]'),fe=pe.find("a.dots");fe.on("click",(function(){pe.find("div:hidden").show().find("a").unwrap(),fe.remove()})),t(".share-buttons a.pinit-marklet").click((function(e){e.preventDefault(),t("#pinmarklet").remove();var i=document.createElement("script");i.setAttribute("type","text/javascript"),i.setAttribute("charset","UTF-8"),i.setAttribute("id","pinmarklet"),i.setAttribute("async","async"),i.setAttribute("defer","defer"),i.setAttribute("src","//web.archive.org/web/20220826151958/https://assets.pinterest.com/js/pinmarklet.js?r="+99999999*Math.random()),document.body.appendChild(i)})),
/*!-Scroll to Top*/
...
/*
     FILE ARCHIVED ON 15:19:58 Aug 26, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 05:34:56 Nov 15, 2023.
...
/*
playback timings (ms):
  captures_list: 104.883
  exclusion.robots: 0.065
  exclusion.robots.policy: 0.057
  cdx.remote: 0.049
  esindex: 0.006
  LoadShardBlock: 75.082 (3)
  PetaboxLoader3.datanode: 227.965 (5)
  load_resource: 240.593
  PetaboxLoader3.resolve: 32.597
  loaddict: 168.448
*/